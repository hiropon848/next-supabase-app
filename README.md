...
`app/page.tsx` を編集してページの変更を開始できます。ファイルを編集すると、ページは自動的に更新されます。

このプロジェクトでは [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) を使用して、Vercel の新しいフォントファミリーである [Geist](https://vercel.com/font) を自動的に最適化および読み込みを行っています。
...
[Next.js の GitHub リポジトリ](https://github.com/vercel/next.js) もぜひチェックしてください。フィードバックや貢献を歓迎しています！
